...
public class HomeFragment extends Fragment {
     ...
     //   mAgeTextView.setText(String.format("Age: %d", age));
        ...
        btnCommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialogBuilder.setMessage("Do you want to Commit?");
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                if (ckConn.equals("WifiCon")){
                                    ...
                                    HomeTaskParams mParams = new HomeTaskParams("Commit", "", 0);
        ...
        myPCName = pref.getString("myPcAddress",null);
        ...
        retryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    HomeTaskParams mParams = new HomeTaskParams("Load", "", 0);
    ...
    private class LongOperation extends AsyncTask<HomeTaskParams, Void, String> {
        ...
        @Override
        protected String doInBackground(HomeTaskParams... params) {
        ...
        try
        {
            ...
            try {
                ...
                try {
                    ...
                    ResultSet rs = stmt.executeQuery("select O.id, O.ItemLookup, O.description, I.in_qty, I.price_changed From itemproduct As O INNER Join tempProAdjustment As I On O.id = I.itemID Where I.adj_type = '"+ type +"' ORDER BY I.dateTime DESC");
        ...
        swipeController = new SwipeController(new SwipeControllerActions() {
            ...
            public void onRightClicked(int position) {
                ...
                if (ckConn.equals("WifiCon")){
                   ...
                   // new LongOperation().execute("Delete");
                    ...
                    HomeTaskParams mParams = new HomeTaskParams("Delete", "", position);
                    new LongOperation(true).execute(mParams);
            ...
            public void onLeftClicked(int position) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    HomeTaskParams mParams = new HomeTaskParams("EDIT", "", position);
                    new LongOperation(true).execute(mParams);
                }else{
                ...
                try {
                    ...
                    if(result == 1) {
                            ...
                            if (tillType.equals("Server")){
                                ...
                                while (newStringsIter.hasNext()) {
                                   // System.out.println("The sting value : " + newStringsIter.next());
                                    ...
                                    //int resulttClient = stmt.executeUpdate("tableName, itemlookup, upType, ipaddress, myPcAddress, updVal) VALUES ('itemProductBO', '" + dictArr.get("itemLU") + "', '"+QtyASCk+"', '" + ipt + "', '" + myPCName + "', '" + QtyValMulti + "')");
                                    int resulttClient = stmt.executeUpdate("insert into IPClientUpd(tableName, itemlookup, upType, ipaddress, myPcAddress, updVal) VALUES ('itemProductBO', '" + dictArr.get("itemLU") + "', '"+QtyASCk+"', '" + ipt + "', '" + myPCName + "', '" + QtyValMulti + "')");
                                    if(resulttClient == 1) {
                               ...
                               // int resulttServer = stmt.executeUpdate("tableName, itemlookup, upType, ipaddress, myPcAddress, updVal) VALUES ('itemProductBO', '" + dictArr.get("itemLU") + "', '"+QtyASCk+"', '" + serIPAdd + "', '" + myPCName + "', '" + QtyValMulti + "')");
                                int resulttServer = stmt.executeUpdate("insert into IPServerUpd(tableName, itemlookup, upType, ipaddress, myPcAddress, updVal) VALUES ('itemProductBO', '" + dictArr.get("itemLU") + "', '"+QtyASCk+"', '" + serIPAdd + "', '" + myPCName + "', '" + QtyValMulti + "')");
                                if(resulttServer == 1) {
                        ...
                        if (Rprice != trackPrice){
                            ...
                            String idIU = "",itemidIU = "", itemLUIU = "", descrIU = "", barCodeIU = "", priceIU = "";
                            String rrPriceIU = "", rrCostIU = "", itemVatIU = "", itemDepIU = "", itemCatIU = "";
                            String depDescrIU = "", depGroupsIU = "", depAgeCheckIU= "", depCommissionIU = "", depVatIU = "", catDescrIU = "", catVatIU = "";

                            ResultSet rsi = stmt.executeQuery("select id, ItemLookup, description, barCode, price, avaiable, vat, Rprice, Rcost, department, category from itemproduct where ItemLookup = '"+dictArr.get("itemLU").toString().trim()+"'");

                            while (rsi.next()) {

                                idIU = rsi.getString("id");
                                itemLUIU = rsi.getString("ItemLookup");
                                descrIU = rsi.getString("description");
                                barCodeIU = rsi.getString("barCode");
                                priceIU = rsi.getString("price");
                                rrPriceIU = rsi.getString("Rprice");
                                rrCostIU = rsi.getString("Rcost");
                                itemVatIU = rsi.getString("vat");
                                itemDepIU = rsi.getString("department");
                                itemCatIU = rsi.getString("category");

                            }

                            ResultSet rsd = stmt.executeQuery("select description, groups, ageCheck, commission, vat from department where depart_id = '"+itemDepIU+"'");

                            while (rsd.next()) {

                                depDescrIU = rsd.getString("description");
                                depGroupsIU = rsd.getString("groups");
                                depAgeCheckIU = rsd.getString("ageCheck");
                                depCommissionIU = rsd.getString("commission");
                                depVatIU = rsd.getString("vat");

                            }

                            System.out.println("Department details : "  + depDescrIU + depGroupsIU + depAgeCheckIU + "comi : "+depCommissionIU+" : " + depVatIU);

                            ResultSet rsc = stmt.executeQuery("select category, vat from category where id = '"+itemCatIU+"'");

                            while (rsc.next()) {

                                catDescrIU = rsc.getString("category");
                                catVatIU = rsc.getString("vat");

                            }

                            ItemUploadTB itemUploadTB;
                            itemUploadTB = new ItemUploadTB(1,"insert",itemidIU.trim(),descrIU.trim(),barCodeIU.trim(),itemVatIU,rrPriceIU,rrCostIU,depDescrIU.trim(),depGroupsIU.trim(),depAgeCheckIU.trim(),depCommissionIU.trim(),depVatIU.trim(),catDescrIU.trim(),catVatIU.trim());

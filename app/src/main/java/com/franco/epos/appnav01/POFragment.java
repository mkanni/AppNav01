...
public class POFragment extends Fragment {
    ...
    private ItemPODataAdapter mAdapterPO;
    ...
    public static POFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        retryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    POFragment.HomeTaskParams mParams = new POFragment.HomeTaskParams("Load", "", 0);
                    new POFragment.LongOperation(false).execute(mParams);
        ...
        mAdapterPO = new ItemPODataAdapter(items);
    ...
    private class LongOperation extends AsyncTask<POFragment.HomeTaskParams, Void, String> {
        ...
        @Override
        protected String doInBackground(POFragment.HomeTaskParams... params) {

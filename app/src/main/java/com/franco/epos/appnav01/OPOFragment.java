 ...
 */
public class OPOFragment extends Fragment {
    ...
    private ItemOPODataAdapter mAdapter;
    SwipeController swipeController = null;

    RecyclerView recyclerViewOPO;
    ...
    public static OPOFragment newInstance(String param1, String param2) {
        OPOFragment fragment = new OPOFragment();
...
//        args.putSerializable(ARG_PARAM3,param3);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_opo_list,   container, false);
                ...
                alertDialogBuilder.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                commitSave("COMMIT");
                               // ((MainActivity) getActivity()).loadPOCSEditFragment("COMMIT",POCode,POCode, POStatus);

                                /*showLoadingActionButton();
                                String ckConn = mConnectionCheck("");
                                if (ckConn.equals("WifiCon")){

                                    OPOFragment.HomeTaskParams mParams = new OPOFragment.HomeTaskParams("Commit", "", 0);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                arrayAdapter.add("Scan and Add");
                arrayAdapter.add("Select from Department");
                arrayAdapter.add("Select from Category");
                arrayAdapter.add("Select from Supplier");
                ...
                builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        typeVal = "";
                        if(strName.equals("Scan and Add")) {
                            typeVal = "ScanAdd";
                        }else if (strName.equals("Select from Department")){
                            typeVal = "Department";
                        }else if (strName.equals("Select from Category")){
                            typeVal = "Category";
                        }else if (strName.equals("Select from Supplier")){
                            typeVal = "Supplier";
                        }else{
                        ...
                        fragmentTransaction.replace(R.id.frame, fragment, "OPO List");
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity) getActivity()).loadBackFragment("Open PO");
        ...
        recyclerViewOPO = (RecyclerView)view.findViewById(R.id.recyclerView);
        ...
        retryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    OPOFragment.HomeTaskParams mParams = new OPOFragment.HomeTaskParams("Load", "", 0);
                    new OPOFragment.LongOperation(false,false,true).execute(mParams);
        ...
        mAdapter = new ItemOPODataAdapter(items);
        recyclerViewOPO.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        recyclerViewOPO.setAdapter(mAdapter);
        // setupRecyclerView();
    ...
    private class LongOperation extends AsyncTask<OPOFragment.HomeTaskParams, Void, String> {
        ...
        @Override
        protected String doInBackground(OPOFragment.HomeTaskParams... params) {
            ...
            if (loadMStrOne.equals("Load")){
                ...
                if (result.equals("Success")){
                   ...
                   // ((MainActivity) getActivity()).loadEditFragment(item.getItemID());
                    ((MainActivity) getActivity()).loadPOEditFragment("ScanAdd",item.getItemLU(), POCode, POStatus);
                }else{
...
//        }
    ...
    public void onDetach() {
        ...
        trans.commit();*/
        //mAdapter.items.clear();
        System.out.println("Back button onDetach : OPOFragment");
        /*List<Item> items = new ArrayList<>();
        mAdapter = new ItemOPODataAdapter(items);
        recyclerViewOPO.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        recyclerViewOPO.setAdapter(mAdapter);*/
            ...
            try
            {
                ...
                try {
                    ...
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("Select p.itemlookup, p.description, i.id, i.qty, i.type, i.vendorCode,p.midasCode FROM purchaseOrder as i JOIN itemProduct as p On i.itemlookup = p.itemlookup where i.PoCode = '"+POCode+"'");
                        //select * from PoCode
                        ...
                        while (rs.next()){
                            ...
                            oPListTB = new OPListTB(1,"","",rs.getString("itemlookup"),rs.getString("qty"),rs.getString("type"),rs.getString("vendorCode"),rs.getString("description"),rs.getString("midasCode"),"0");
    ...
    private void setupRecyclerView() {
        ...
        swipeController = new SwipeController(new SwipeControllerActions() {
            ...
            public void onRightClicked(int position) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    OPOFragment.HomeTaskParams mParams = new OPOFragment.HomeTaskParams("Delete", "", position);
                    new OPOFragment.LongOperation(true, true, true).execute(mParams);
            ...
            public void onLeftClicked(int position) {
                ...
                if (ckConn.equals("WifiCon")){
                    ...
                    OPOFragment.HomeTaskParams mParams = new OPOFragment.HomeTaskParams("EDIT", "", position);
                    new OPOFragment.LongOperation(true, true,true).execute(mParams);
                }else{
        ...
        itemTouchhelper.attachToRecyclerView(recyclerViewOPO);

        recyclerViewOPO.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
        ...
        recyclerViewOPO.addOnItemTouchListener(

...
public class UpdALItemActivity extends Activity {
    ...
    private EditText itemSearch, itemDescription, itemVat, itemStock, itemPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upd_al_item);
       ...
       // itemQty = findViewById(R.id.input_qty);
        itemVat = findViewById(R.id.input_vat);
        ...
        btnScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(UpdALItemActivity.this, BarcodeActivity.class);
               // i.putExtra("ActType", CURRENT_AVAL);
                i.putExtra("ActFrom", "edit");
              //  i.putExtra("itmID", itmID);
                startActivityForResult(i, 10001);
...
//                System.out.println("pack quantity action type : "+ actionType + dictVal.get("itemLU").toString());
                ...
                if (itemSearch.getText().toString().trim().length() < 1) {
                    ...
                    Intent i = new Intent(UpdALItemActivity.this, OtherActivity.class);
    ...
    private void finishLongTask (String action,String val){
        ...
        if (action.equals("Success")) {
            ...
            itemVat.setText(dictVal.get("vat").toString());
           ...
           // dictVal = dictTemp;
            ...
            /*AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
            alertDialogBuilder.setMessage("Item id already exists!");
    ...
    private String mSaveItem(String type) {
        ...
        if (stmt != null){
            ...
            ckExp = mCount("select * from LabelPrint where itemlookupCode = '"+dictVal.get("itemLU")+"'");
            ...
            if (ckExp.equals("SqlExp")) {
                ...
                try {
                    ...
                    //"INSERT INTO LabelPrint(itemlookupCode, decription, barcode, department, price, sizegroup) VALUES ('" & itemlookup & "','" & description & "','" & barcode & "','" & vat & "','" & CType(price, Decimal) & "', '" & sizegroup & "')"

                    int result = stmt.executeUpdate("insert into LabelPrint(itemlookupCode,decription,barcode,department,price,sizegroup)values('" + dictVal.get("itemLU") + "','" + dictVal.get("descr") + "','" + dictVal.get("barCode")  + "','" + dictVal.get("vat") + "', '" + dictVal.get("price") + "', '" + dictVal.get("sizeGroup") + "')");
                    if(result == 1){
    ...
    private String mSaveAlreary(String type, String val){
        ...
        if (stmt != null){
            try {
                ...
                int result = stmt.executeUpdate("UPDATE tempProAdjustment SET staff_id='" + staffID + "', dateTime='" + logdat + "',in_qty = '1',cur_stock = '" + dictVal.get("stock").toString().trim() + "',cur_price = '" + dictVal.get("price") + "',price_changed = '" + itemPrice.getText().toString().trim() + "',reason = '" + itemVat.getText() + "' WHERE itemID='" + dictVal.get("itemId") + "'");
                if(result == 1){
    ...
    private String setEditItemAdapter(String type, String itmID){
        ...
        dictTemp = selectArray("itemTemp", "select O.id, O.ItemLookup, O.description, O.barCode, O.vat, O.sizeGroup, I.price_changed, O.avaiable, I.in_qty, I.reason, I.adj_type From itemproduct As O INNER Join tempProAdjustment As I On O.id = I.itemID Where (I.adj_type = '" + type + "' AND I.itemID = '" + itmID + "')");
        ...
        if (!ckExp.equals("SqlExp")){
            ...
            if (resCountTM > 0) {
                ...
                itemVat.setText(dictTemp.get("reason").toString());
    ...
    private String setSerItemDataAdapter(final String type) {
        ...
        dict = selectArray("itemProduct","select id, ItemLookup, description, barCode, vat, sizeGroup, price, avaiable from itemproduct where barCode = '"+itemSearch.getText().toString().trim()+"' OR ItemLookup = '"+itemSearch.getText().toString().trim()+"'");
                ...
                if (!ckExp.equals("SqlExp")){
                    ...
                    /*if (resCountCK > 0){
                        ...
                        *//*AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                        ...
                        Dictionary dictTemp = new Hashtable();
                        dictTemp = selectArray("itemTemp", "select O.id, O.ItemLookup, O.description, O.barCode, O.vat, I.price_changed, O.avaiable, I.in_qty, I.reason, I.adj_type From itemproduct As O INNER Join tempProAdjustment As I On O.id = I.itemID Where (I.adj_type = '" + actionType + "' AND I.itemID = '" + dict.get("id") + "')");
                        Integer resCountTM = Integer.parseInt(String.valueOf(dictTemp.get("count")));
                        ckExp = dictTemp.get("error_type").toString();
    ...
    private Dictionary selectArray(String type, String query) {
        ...
        Integer count = 0;
        String id = "",itemid = "", itemLU = "", descr = "", vat = "", sizeGroup = "", barCode = "", price = "", stock = "", in_qty = "", reason = "", adj_type = "", error_type = "Success";
        ...
        if (stmt != null) try {
            ...
            while (rs.next()) {
                ...
                if (type.equals("itemTemp")) {
                    ...
                    sizeGroup = rs.getString("sizeGroup");
